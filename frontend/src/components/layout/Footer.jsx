...
const Footer = () => {
  ...
  const SOCIAL_LINKS = {
    instagram: 'https://www.instagram.com/the_.rawcanvas._/',
    facebook: 'https://www.facebook.com/TheRawCanvas21',
    whatsappCommunity: 'https://whatsapp.com/channel/0029VaEhWdw5Ui2f1o5aLH2Z',
  }
  ...
  const socialLinks = [
    { icon: FaInstagram, href: SOCIAL_LINKS.instagram, color: 'hover:text-pink-500', label: 'Instagram' },
    { icon: FaFacebookF, href: SOCIAL_LINKS.facebook, color: 'hover:text-blue-600', label: 'Facebook' },
    { icon: FaWhatsapp, href: SOCIAL_LINKS.whatsappCommunity, color: 'hover:text-green-500', label: 'WhatsApp Community' },
  ]
            ...
            >
              {subscribed ? (
                ...
                <motion.div
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-green-500 text-white rounded-full font-bold"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a href="mailto:therawcanvase@gmail.com" className="flex items-center gap-3 text-cream-300 hover:text-gold-400 transition-colors">
                <HiOutlineMail className="w-5 h-5" />
                therawcanvase@gmail.com
              </a>
              <a href="tel:+918291271695" className="flex items-center gap-3 text-cream-300 hover:text-gold-400 transition-colors">
            ...
            {/* Social Links */}
            <div className="mt-6">
              <p className="text-sm text-cream-400 mb-3">Follow us:</p>
              <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.name}>
                  <Link to={link.path} className="text-cream-300 hover:text-gold-400 transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
