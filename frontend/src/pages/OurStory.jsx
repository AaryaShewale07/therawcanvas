...
const OurStory = () => {
  const milestones = [
    ...
    },
    {
      ...
      description: 'Introduced hands-on workshops to unite creative souls under one roof, where everyone can experience the joy of making something with their own hands.',
    },
  ]
